import 'package:fitness_app/features/auth/presentation/views/create_account_1.dart';
...
abstract class AppRouer {
  ...
  static const kCreateAccount1 = '/createAccount';
  static final router = GoRouter(
    routes: [
      ...
      GoRoute(
        ...
        builder: (context, state) => CreatAccount1(),
      ),
    ],
  );
}
